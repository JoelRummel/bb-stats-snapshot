...
<body>
	...
	<div id="ItemBox">
		...
		<div>
			...
			switch ($_GET["i"]) {
				...
				case "Gear Lube": $str="Speeds up your turret tracking, allowing you to aim at enemies much faster."; break;
				case "Rudder": $str="Increases the turning speed of your ship. Great for close combat brawling."; break;
	...
	<script src="js_item_experimental.php?i=<?php echo $_GET['i']; ?>"></script>
</body>
</html>